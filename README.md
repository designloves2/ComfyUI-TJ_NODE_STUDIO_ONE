...
| 추천 | 다운로드 |
|---|---|
| huihui-ai GGUF 컬렉션 (Qwen · Llama · Mistral 계열) | [noctrex/huihui-ai 컬렉션](https://huggingface.co/collections/noctrex/huihui-ai) |
...
| huihui-ai Qwen3-VL 계열 GGUF | [noctrex/huihui-ai 컬렉션](https://huggingface.co/collections/noctrex/huihui-ai) |
