// ui_t2i_klein.js — T2I left panel for flux2 klein One (TJ)
import { C, el, clear } from "./core_klein.js";
import { panel, label, select, numberField, slider, row, col } from "./ui_common.js";
import { buildT2IGraph } from "./graph_builder_klein.js";
...
export function mountT2ILeft(leftEl, state, ctx) {
  ...
  wrap.appendChild(panel([
    ...
    row([
      col([label("Sampler"),   select(["euler","euler_ancestral","er_sde","dpm_2","dpm_2_ancestral","lms","dpm_fast","dpm_adaptive","heun","dpm_pp_2m"], state.sampler,   v => { state.sampler   = v; ctx.persist(); })]),
