// ui_image_upload.js — shared image upload box for Krea 2 ONE STUDIO (TJ).
//
// Before this file existed, ui_i2i_krea2.js, ui_identity_krea2.js, ui_controlnet_krea2.js
// and ui_upscale_krea2.js each hand-rolled their own near-identical copy of this box (one
// even inline, no factory function at all) — which is why this tool's image-loading cards
// didn't get the "🖼 Load from gallery" button when Klein/Z-Image/SDXL did: there was no
// single place to add it. One real factory now, matching Klein's/Z-Image's own
// ui_image_upload.js shape, used by all four.
import { C, el } from "./core_krea2.js";
...
export function createImageUpload(labelText, initialFile, onUpload,
  ...
  // only a local file. uploadImage() (api_krea2.js) passes a string straight through
