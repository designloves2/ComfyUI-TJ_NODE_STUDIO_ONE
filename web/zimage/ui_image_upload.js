...
export function createImageUpload({ label = "Image", onUpload, initialFilename = null, maxPixels = null, onLoad = null } = {}) {
  ...
  // local file. uploadImage() (api.js) passes a string straight through unchanged, so
  // onUpload's existing "upload then set state" call sites work for a gallery pick too.
