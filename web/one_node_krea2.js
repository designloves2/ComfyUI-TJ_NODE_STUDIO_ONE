...
app.registerExtension({
  ...
  async beforeRegisterNodeDef(nodeType, nodeData) {
    if (nodeData.name !== "Krea2OneTJNode") return;
    ...
    nodeType.prototype._buildUI = function () {
      ...
      if (!document.getElementById("k2v3-styles")) {
        const s = document.createElement("style"); s.id = "k2v3-styles";
        s.textContent = `@keyframes k2v3-spin{to{transform:rotate(360deg)}}.k2v3-lp::-webkit-scrollbar{width:4px}.k2v3-lp::-webkit-scrollbar-track{background:transparent}.k2v3-lp::-webkit-scrollbar-thumb{background:${C.border};border-radius:2px}`;
      ...
      function showPopup(msg, isError=true) {
        let pop = root.querySelector(".k2v3-pop");
        if (!pop) {
          ...
          pop.className="k2v3-pop"; root.appendChild(pop);
        }
      ...
      const spinner     = el("div",{style:{width:"44px",height:"44px",border:`3px solid ${C.border}`,borderTop:`3px solid ${BRAND}`,borderRadius:"50%",animation:"k2v3-spin 0.8s linear infinite"}});
      ...
      helpTop.appendChild(el("div",{text:t("k2help_title"),style:{color:"#fff",fontSize:"14px",fontWeight:"700",flex:"1"}}));
      ...
      helpBody.className="k2v3-lp";
      [
        [t("k2help_s0_title"), t("k2help_s0_body")],
        [t("k2help_s1_title"), t("k2help_s1_body")],
        [t("k2help_s2_title"), t("k2help_s2_body")],
        [t("k2help_s3_title"), t("k2help_s3_body")],
        [t("k2help_s4_title"), t("k2help_s4_body")],
        [t("k2help_s5_title"), t("k2help_s5_body")],
        [t("k2help_s6_title"), t("k2help_s6_body")],
      ].forEach(([title,body])=>{
