// api_sdxl.js — ComfyUI backend communication for SDXL ONE (TJ)
import { api } from "../../../scripts/api.js";
import { API, SUBFOLDER } from "./core_sdxl.js";
...
export async function getESRGANModels() {
  const r = await api.fetchApi(`${API}/esrgan_models`);
  return r.json();
}
...
export async function saveMeta(filename, subfolder, stateObj) {
  ...
  } catch(e) { console.warn("[SDXL] saveMeta:", e); }
}
